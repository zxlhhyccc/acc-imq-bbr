...
define KernelPackage/ath11k
  ...
  +@LINUX_5_15:kmod-qcom-qmi-helpers +kmod-crypto-michael-mic +ATH11K_THERMAL:kmod-hwmon-core \
...
define KernelPackage/ath11k-pci
  ...
  URL:=https://wireless.wiki.kernel.org/en/users/drivers/ath11k
  DEPENDS+= @PCI_SUPPORT @TARGET_ipq807x +@LINUX_5_15:kmod-qrtr-mhi +kmod-ath11k
